    ...
    <View style={styles.explore}>
      ...
      <View style={[styles.frame1, styles.frameFlexBox]}>
        <View style={styles.frame2}>
          <Text style={styles.findTypo}>Find Products</Text>
...
& Ghee`}</Text>
      ...
      <View style={[styles.frame9, styles.frameLayout]}>
        <View style={styles.frameView}>
          <Image
            style={[styles.pngfuel6Icon4, styles.pngfuel6IconLayout]}
            resizeMode="cover"
            source={require("../assets/pngfuel-64.png")}
          />
          <Text style={[styles.h16, styles.h1Typo]}>Beverages</Text>
          <View style={[styles.ellipseParent, styles.ellipseLayout]}>
            ...
            <View style={styles.frameChild3Position} />
        ...
        <View style={[styles.frameGroup, styles.frameGroupPosition]}>
          ...
          <Image
            style={[styles.pngfuel6Icon5, styles.pngfuel6IconLayout]}
            resizeMode="cover"
            source={require("../assets/pngfuel-65.png")}
          />
          <Text style={[styles.h17, styles.h1Typo]}>{`Dairy & Eggs`}</Text>
        </View>
